 ...
 *
 * <p>
 * Detalhamento da Consolidação - Operações de Aquisição Com Direito a Crédito, eOperações de Devolução de Compras e
 * Vendas – Cofins
 * </p>
 *
 * <p>
 ...
 */
@Record(fields = {
    @Field(name = "reg", id=true, constantValue = "C195"),
    @Field(name = "cnpjCpfPart", maxLength = 14),
