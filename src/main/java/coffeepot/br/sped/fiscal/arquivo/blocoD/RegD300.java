 ...
 */
@Record(fields = {
    @Field(name = "reg", id=true, constantValue = "D300"),
    @Field(name = "codMod"),
    @Field(name = "ser"),
    @Field(name = "sub"),
    ...
    @Field(name = "codCta"),
    //--- detalhes ---
    @Field(name = "regD301List"),
    @Field(name = "regD310List")
})
@Getter
@Setter
public class RegD300 {
    ...
    //--- detalhes ---
    private List<RegD301> regD301List;
    private List<RegD310> regD310List;
